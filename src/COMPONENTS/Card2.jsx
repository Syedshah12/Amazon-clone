...
const Card2 = ({src,id,title}) => {
  return (
   


<div key={id} className='w-40  xs:w-48 sm:h-72 sm:w-64 md:w-60 md:h-96 lg:w-72 drop-shadow-md  h-60 bg-white px-3  overflow-hidden  '>
<div className='h-[15%] w-full flex items-end mb-2 text-[1.4rem] py-3  sm:text-2xl  text-black font-semibold'><h2>{title}</h2></div>
